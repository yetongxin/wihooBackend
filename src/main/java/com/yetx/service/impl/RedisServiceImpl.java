...
public class RedisServiceImpl implements RedisService {
    ...
    public void initQuestionPopuStart(){
        ...
        List<Question> list = (List<Question>) questionService.findAllQuestions(1, N).getCurData();
        for(Question question:list){
            //初始化，question排行榜初始为按时间排序的几个。
            redisOperator.zAdd(QUESTION_KEY,question.getId(),1);
